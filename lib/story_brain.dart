...
class StoryBrain {
  ...
  nextStory(int choiceNumber) {
    if (this._storyData[_storyNumber].results == null) {
      this._storyNumber = 0;
    }
    this._storyNumber = this._storyData[_storyNumber].results[choiceNumber];
  }

  bool isFinished() {
    return <int>[0, 1, 2].contains(this._storyNumber);
  }
